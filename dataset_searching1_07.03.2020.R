...
for (p in prefixes_list) {
  ...
  } #this is matrix.ing, but with the order meaning that colnames come out correctly in some locations only (with no grep.ing required, just the following if loop to select the right locations)
} 
if (dfs_no==1) {
  ...
  trial_list<-list(dfs_list_b[[1]][[1]][[1]][[1]][[1]][[1]][[1]][[1]][[2]],dfs_list_b[[1]][[1]][[1]][[1]][[2]],dfs_list_b[[2]]) 
  trial_list_c<-c(dfs_list_b[[1]][[1]][[1]][[1]][[1]][[1]][[1]][[1]][[2]],dfs_list_b[[1]][[1]][[1]][[1]][[2]],dfs_list_b[[2]]) 
} else if (dfs_no==4) {
  a<- dfs_list_b[[2]] #last
  ...
  trial_list<-list(a,b,c,d,e,f) 
  trial_list_c<-c(a,b,c,d,e,f) 
} else if (dfs_no==7) {
  a<-dfs_list_b[[2]] #last
  ...
  trial_list<-list(a,b,c,d,e,f,g) 
  trial_list_c<-c(a,b,c,d,e,f,g) 
} else if (dfs_no==8) {
  a<-dfs_list_b[[2]] #last
  ...
  trial_list<-list(a,b,c,d,e,f,g,h) 
  trial_list_c<-c(a,b,c,d,e,f,g,h) 
} else {print("error")}
